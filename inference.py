...
tokenizer = AutoTokenizer.from_pretrained('/root/autodl-tmp/checkpoints/DuReaderQG/model_best/', local_files_only=True)
model = T5ForConditionalGeneration.from_pretrained('/root/autodl-tmp/checkpoints/DuReaderQG/model_best/', local_files_only=True)
